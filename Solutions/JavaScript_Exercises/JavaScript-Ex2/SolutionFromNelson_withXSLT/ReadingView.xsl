...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <script type="text/javascript" src="saidToggle.js">/**/</script>
            </head>
            <body>
                ...
                <div id="checkboxes">
                    ...
                    <ul>
                        <!-- rjp: The following series of xsl:if statements make it so the checkbox for the specified archetype only appears when that archetype speaks in the article. This is to avoid extra checkboxes appearing that when clicked wouldn't toggle any text because there is no speech from that archetype. -->
                ...
                <div id="article">
                    ...
                    <!-- rjp: these series of if statements are because some articles have multiple sections where there are new set of headlines and some only have one set. -->
    ...
    <!-- rjp: This template match is for filters that are not focused on version comparison; this rule selects the reading of the original article as the only one that appears. -->
