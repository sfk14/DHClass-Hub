...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
   ...
   <xsl:variable name="heightAdjust" select="5"/>
    ...
    <xsl:template match="/">
        <svg width="900" height="1000" viewBox="0 0 1000 1200">
      <!--ebb: We started with just width="100%" and height="200%" which works for the output to be fully visible and make the questions large enough to read by scrolling down. After some futzing, I set the width and height to be slightly wider and about about twice as long as what I need to see output in a browser window, and still scroll. The viewBox is roughly proportional to the actual height and width. If I make the x and y values there larger, I'll shrink the graph, and if I make them smaller, parts of it are cut off in the output.
          Any setting here that works to make your output visible in the browser window is fine!
      -->
