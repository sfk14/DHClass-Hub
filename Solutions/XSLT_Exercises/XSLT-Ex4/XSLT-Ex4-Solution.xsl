...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>HTML Transformation of 1888-07-30 Nelson Article</title>
                <link rel="stylesheet" type="text/css" href="nelsonStyle.css"/>
            </head>
            <body>
                <h1>
                    <xsl:apply-templates select="//head/newspaperTitle"/>
                </h1>
                <h2>
                    <xsl:apply-templates select="//head/seriesTitle"/>
                </h2>
                <h3>
                    <xsl:apply-templates select="//head/byline"/>
                </h3>
                <h3>
    ...
    <xsl:template match="dialogue/mascVoice">
        <xsl:text>*Male Speaker:</xsl:text>
        <span class="mascVoice">
            <xsl:apply-templates/>
        </span>
        <xsl:text>*</xsl:text>
    </xsl:template>
